from algos.common.critic_multihead import CriticSMultiHead as CostCritic
from algos.common.actor_gaussian import ActorGaussian as Actor
from algos.common.critic_base import CriticS as RewardCritic
...
class Agent(AgentBase):
    def __init__(self, args) -> None:
        ...
        self.con_lam_lr = args.con_lam_lr
        ...
        self.con_lambdas_optimizer = torch.optim.Adam([self.log_con_lambdas], lr=self.con_lam_lr)
    ...
    def train(self):
        # get batches
        with torch.no_grad():
            states_tensor, actions_tensor, reward_targets_tensor, cost_targets_tensor, reward_gaes_tensor, cost_gaes_tensor = \
        ...
        with torch.no_grad():
            ...
            reduced_gaes_tensor = reward_gaes_tensor - torch.sum(con_lambdas.unsqueeze(0)*cost_gaes_tensor, dim=-1)
