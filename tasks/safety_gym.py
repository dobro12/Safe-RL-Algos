...
class GymEnv(gym.Env):
    ...
    def step(self, action):
        ...
        info['costs'] = [self._get_cost(h_dist)]
        info['cvs'] = [num_cv]
        info['rewards'] = [reward]
...
class PointGoal3Env(GymEnv):
    def __init__(self, seed=0, max_episode_length=1000, action_repeat=1):
        super().__init__('Safexp-PointGoal1-v0', seed, max_episode_length, action_repeat)

class CarGoal3Env(GymEnv):
    def __init__(self, seed=0, max_episode_length=1000, action_repeat=1):
        super().__init__('Safexp-CarGoal1-v0', seed, max_episode_length, action_repeat)
